...
class Recomendaciones extends Component
{
    ...
    public function render() {
        $this->fichas=asmFicha::select('id','nombre')
            ->where('deleted',0)
        ...
        elseif(!empty($this->anio)){
            ...
            // ->asmFicha->whereYear('fecha_inicial',$this->anio)->get();
        ...
        return view('livewire.monitoreo.asm.recomendaciones-list',$this->data);
    }
}
