...
class cat_systems_seed extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('cat_systems')->insert(['siglas' =>  'MIR','nombre' =>  'Matriz de Indicadores para Resultados','descripcion' =>  '<h2MIR</h2>
        <p>&nbsp;</p>
        ...
        DB::table('cat_systems')->insert(['siglas' =>  'M.E','nombre' =>  'Metas Estrategicas','descripcion' =>  '<h2>M.E.</h2>
