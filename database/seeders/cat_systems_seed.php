...
class cat_systems_seed extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table($table)->insert(['id'=>1,'siglas' =>  'SPME','nombre' =>  'Sistema de Planeación Monitoreo y Evaluación','descripcion' =>  '<h2>SPME</h2>
        <p>SYSTEM</p>','active' => 1,'deleted' =>0,'created_at' =>  '2023-05-17 14:51:39','updated_at' =>  '2023-05-17 14:51:39','active_at' =>  '','deleted_at' =>  '']);
        DB::table($table)->insert(['id'=>2,'siglas' =>  'ASM','nombre' =>  'Aspectos Susceptibles de Mejora','descripcion' =>  '<h2>ASM</h2>
        ...
        DB::table($table)->insert(['id'=>3,'siglas' =>  'PAT','nombre' =>  'Programa Anual de Trabajo','descripcion' =>  '<h2>PAT</h2>
        ...
        DB::table($table)->insert(['id'=>4,'siglas' =>  'MIR','nombre' =>  'Matriz de Indicadores para Resultados','descripcion' =>  '<h2MIR</h2>
        <p>&nbsp;</p>
        ...
        DB::table($table)->insert(['id'=>5,'siglas' =>  'M.E','nombre' =>  'Metas Estrategicas','descripcion' =>  '<h2>M.E.</h2>
