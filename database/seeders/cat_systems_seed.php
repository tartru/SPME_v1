...
class cat_systems_seed extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('cat_systems')->insert(['siglas' =>  'PAT','nombre' =>  'Programa Anual de Trabajo','descripcion' =>  '<h2>PAT</h2>
        ...
        DB::table('cat_systems')->insert(['siglas' =>  'MIR','nombre' =>  'Matriz de Indicadores para Resultados','descripcion' =>  '<h1 class="ms-rteElement-ConevalTitulo">MATRIZ DE INDICADORES PARA RESULTADOS</h1>
        <p>&nbsp;</p>
        ...
        DB::table('cat_systems')->insert(['siglas' =>  'M.E','nombre' =>  'Metas Estrategicas','descripcion' =>  '<h2>Metas Estrategicas</h2>
