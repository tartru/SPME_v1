 ...
 * CatTipoCaptura
 * 
 * Entidad que maneja el catálogo de tipos de captura
 * 
 * 
 * 
...
namespace SPME\System\Admin\CatTipoCaptura\Entity;
...
class CatTipoCaptura extends Entity {
    ...
    public function __construct(Repository $repository, ?Array $params = null, ?QueryManager $newQueryManager = null) {
        $this->setTable('cat_tipo_captura');
