    ...
    @if(isset($update)||isset($nuevo))
        @include('layouts.FormEdit', [
            ...
            'headers' => [
                ...
                'position'     => ['txt'=>'Posición','type'=>'tint-1-si-0-si'],
                'nombre'      => ['txt'=>'Nombre','type'=>'varchar-45-si-no-si'],
                ...
                'activated_at' => ['txt'=>'Activado el','type'=>'timestamp-3-no-null-no'],
                'deleted_at' => ['txt'=>'Eliminado el','type'=>'timestamp-3-no-null-no'],
            ],
