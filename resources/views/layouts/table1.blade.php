...
<div>
        ...
        @if ( !empty($table_config) && !empty($table_config['actions']) && !empty($table_config['actions']['search_columns']) )
            ...
            @else
                <div class="dataTables-filter-wrapper card">
                    <div class="card-body">
                        <h5 class="card-title accordion-header-like">Filtrar</h5>
            @endif
            ...
            @endphp
            @foreach ( $table_config['actions']['search_columns'] as $_h_key => $_s_c_val )
    ...
    {{-- Tabla de datos --}}
        <table id="{{ $_data_table_id }}" class="table table-striped dt-table-hover" style="width:100%;">
            <thead>
                <tr>
                        ...
                        <tr>
                            ...
                            @foreach ( $table_config['headers'] as $_h_key => $_h_val )
                                <td>
                                    ...
                                    @else
                                        @php 
                                            if($_h_key=='CVE_ENTIDAD')
                                            print_r ($row['cve_entidad']);
                                            else
                                            if($_h_key=='CVE_ENT_MUN')
                                            print_r ($row['cve_ent_mun']);
                                            else
                                            if($_h_key=='CVE_MUN')
                                            print_r ($row['cve_mun']);
                                            else
